...
Household data is available at a high level of geographical granularity, and, since the release of Census data from 2011, in two timesteps (2001 and 2011).
...
## Heating Degree Days
Heating degree days are only available up to 2006, at [UKCIP](http://www.metoffice.gov.uk/climatechange/science/monitoring/ukcip2009.html) but can be calculated from UKCP09 monthly data using the formula [here](http://www.metoffice.gov.uk/climatechange/science/monitoring/ukcp09/faq.html#faq1.8). Data will be available one registration has been approved.
